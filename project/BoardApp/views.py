...
from .forms import (PostForm,
                    RespondForm,
                    ResponsesFilterForm)
from .tasks import (respond_send_email,
                    respond_accept_send_email)
...
class PostItemViews(DetailView):
    model = Post
...
class EditPostViews(PermissionRequiredMixin, UpdateView):
...
class DeletePostViews(PermissionRequiredMixin,DeleteView):
...
class ResponsesViews(LoginRequiredMixin, ListView):
    model = Response
    template_name = 'responses.html'
    context_object_name = 'responses'

    def get_context_data(self, **kwargs):
        context = super(ResponsesViews, self).get_context_data(**kwargs)
        global title
...
class RespondViews(LoginRequiredMixin, CreateView):
    model = Response
    ...
    def form_valid(self, form):
        ...
        respond.save()
        respond_send_email.delay(response_id=respond.id)
